package dev.aryapreetam.components.widgets
    ...
    Row(
        ...
        A(
            ...
            attrs = {
                ...
                onMouseEnter { event ->
                    (event.target as? org.w3c.dom.HTMLElement)?.style?.color = hoverColor.toString()
                }
                onMouseLeave { event ->
                    (event.target as? org.w3c.dom.HTMLElement)?.style?.color = iconColor.toString()
                }
            }
        ) {
            Svg(
        ...
        // LinkedIn icon
        A(
            href = "https://www.linkedin.com/in/preetambhosle",
            attrs = {
                attr("target", "_blank")
        ...
        // X (Twitter) icon
        A(
            href = "https://x.com/preetambhosle",
            attrs = {
                attr("target", "_blank")
                attr("rel", "noopener noreferrer")
        ...
        // GitHub icon
        A(
            href = "https://github.com/aryapreetam",
            attrs = {
                attr("target", "_blank")
                attr("rel", "noopener noreferrer")
